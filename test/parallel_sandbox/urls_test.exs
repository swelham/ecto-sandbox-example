defmodule ParallelSandbox.UrlsTest do
  use ParallelSandbox.DataCase

  alias ParallelSandbox.Urls

  describe "urls" do
    alias ParallelSandbox.Urls.Url

    import ParallelSandbox.UrlsFixtures
